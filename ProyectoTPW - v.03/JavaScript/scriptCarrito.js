...
const incrementButtons = document.querySelectorAll('.product-cart-button button:nth-child(3)');
const decrementButtons = document.querySelectorAll('.product-cart-button button:nth-child(1)');
...
function incrementQuantity(event) {
	...
	const quantityElement = product.querySelector('.product-cart-button p');
